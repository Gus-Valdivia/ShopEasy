...
<%
    ...
    List<Producto> todosLosProductos = productoDAO.getProductosPorTipo(tipoProducto);
%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <header class="hdr">
            ...
            <nav class="nav-links">
                <a href="Inventario2.jsp?tipo=<%=tipoProducto%>" class="button button-light">Inventario</a>
        ...
        <script>
            ...
            function editarProducto(idProducto) {
                window.location.href = '../EditarProductoProveedor.jsp?productoId=' + idProducto;
            }
        </script>
